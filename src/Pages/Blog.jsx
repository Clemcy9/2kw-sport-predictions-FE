        ...
        <div>
            ...
            <div className="gap-5 border-none lg:p-4 mx my-3 mt-7 w-full z-20 relative min-h-screen flex flex-col justify-center items-center bg-[#e0e2e685]">
                            ...
                            <div className="lg:grid lg:grid-cols-3 lg:gap- sm:grid sm:grid-cols-2 sm:gap-6 gap-4 w-full sm:items-center sm:w-full sm:justify-center flex flex-col ">
                                {blogs.map(blog => (
                                    <article key={blog._id} className="group overflow-hidden bg-white flex items-center justify-center flex-row lg:flex-col lg:gap-2 sm:flex-col lg:rounded-[0.5em] gap-1 rounded-[0.5em] lg:h-auto h-32 hover:-translate-y-1 transition-all lg:w-auto w-full sm:h-auto  shadow-sm  lg:shadow-sm ">
