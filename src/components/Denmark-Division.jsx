...
export default function DenmarkCard () {
    ...
    return (
        <div className="border-none md:p-4 my-2 w-full min-w-full flex justify-center items-center flex-col space-y-4 md:space-y-2">

                <div className="bg-[#1A365D] w-full flex justify-between items-center p-2 rounded-[0.6rem] hover:shadow-lg transition-all text-white">
               ...
               {open && (
                ...
                >
                    ...
                    {/* second row */}
                    <div className="hover:shadow-lg transition-all border border-[#D6AE3E] flex justify-between items-center w-ful px-4 flex-col md:flex-row md:p-0 rounded-[0.6rem]">
