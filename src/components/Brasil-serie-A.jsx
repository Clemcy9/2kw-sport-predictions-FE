...
export default function BrasilCard () {
    ...
    return (
        <div className="border-none md:p-4 my-2 w-full flex justify-center items-center flex-col space-y-4 md:space-y-2">
               ...
               {open && (
                ...
                >
                    <div className="hover:shadow-lg transition-all mt-1 border border-[#D6AE3E] flex justify-between items-center px-4 w-ful flex-col md:flex-row md:p-0 rounded-[0.6rem] max-w-full md:max-w-fit">
                    ...
                    {/* second row */}
                    <div className="hover:shadow-lg transition-all border border-[#D6AE3E] px-4 flex justify-between items-center w-ful flex-col md:flex-row md:p-0 rounded-[0.6rem]">
