...
export default function DummyBlog ({images}) {
    ...
    return (
          <div >
              <article className="bg-white flex items-center justify-center flex-row lg:flex-col lg:gap-2 sm:flex-col lg:rounded-[0.5em] gap-1 rounded-[0.5em] lg:h-auto h-32 hover:scale-95 transition-all lg:w-auto w-full sm:h-auto  shadow-sm  lg:shadow-sm ">
