    ...
    return (
        <div className="my-3 mt-7  w-full z-20 relative min-h-screen flex flex-col justify-center items-center bg-[#F3F4F64D]">
            ...
            <div className="lg:grid lg:grid-cols-3 sm:grid sm:grid-cols-2 sm:gap-6 gap-3 w-full sm:items-center sm:w-full sm:justify-center flex flex-col ">
                ...
                <article className="flex items-center justify-center flex-row lg:flex-col sm:flex-col lg:rounded-[0.5em] gap-1 rounded-[0.5em] lg:h-auto h-auto hover:scale-95 transition-all lg:w-[308px] w-auto min-w-[08px] sm:w-[350px] sm:h-auto  shadow-sm  lg:shadow-sm ">
                    <div className="lg:w-[308px] lg:h-auto sm:w-[350px] sm:h-auto w-auto h-[195px]">
                ...
                <article className="flex items-center justify-center flex-row lg:flex-col sm:flex-col lg:rounded-[0.5em] gap-1 rounded-[0.5em] lg:h-auto h-auto hover:scale-95 transition-all lg:w-[308px] w-auto sm:w-[350px] sm:h-auto  shadow-sm  lg:shadow-sm ">
                    <div className="lg:w-[308px] lg:h-auto sm:w-[350px] sm:h-auto w-auto h-[195px]">
                        <img src="/Blog-bg.jpg" alt="blog" className=" rounded-l-[0.5rem] h-full w-full lg:rounded-bl-none lg:rounded-t-[0.4rem] sm:rounded-bl-none sm:rounded-t-[0.5rem] bg-cover" />
                    </div>
                    <div className="lg:px-2 px-1 sm:px-2 py-0 flex flex-col gap-3 sm:gap-0">
