...
export default function BestPredictionCard () {
    ...
    return (
        <div className="relative border-none xs:mt-10 sm:mt-10 md:mt-0 mt-26 lg:mt-5 lg:h-[210px] h-auto min-h-[160px] rounded-[0.6rem] lg:mb-0 px-2 bg-[#1a365d] lg:max-w-full w-full flex items-center flex-col hover:-translate-y-1 hover:shadow-xl lg:space-y-0 shadow-sm transition-all">
