...
export default function PredictionDetails() {
	...
	return (
     ...
     {loading ? (
        <div className=" hover:shadow-lg text-[#1a365d] py-20 hover:bg-[#FFF7E0] group transition-all flex justify-center items-center w-full rounded-[0.6rem] p-2"><span><FaSpinner className="animate-spin" /> </span> Loading History...</div>
        ) : error ? (
            ...
            <div className="text-center text-[#1a365d] py-20 flex justify-center items-center"> No History Available <FaTriangleExclamation className="text-red-600 animate-pulse"/>...</div>
         ) : (
