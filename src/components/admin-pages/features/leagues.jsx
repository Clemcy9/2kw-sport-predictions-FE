                   ...
                   <h2 className="lg:font-semibold font-bold font-[Inria Sans] mb-4 text-center w-full lg:text-left">Football Leagues</h2>
                    ...
                    <div className="w-full flex flex-col lg:flex-row lg:justify-between lg:my-4  gap-7 lg:gap-5">
                        ...
                        <div className="relative lg:w-60 w-full flex justify-between items-center">
                            <input value={byName} onKeyDown={(e) => e.key === "Enter key" && all_predictions} onChange={(e) => setByName(e.target.value)} type="text" placeholder="Search By Name" className="w-full appearance-none border border-[#737373] rounded-[0.9em] py-1 pl-4 pr-10 text-[#737373] focus:ring focus:ring-[#1A365D] focus:border-[#1A365D] outline-none bg-white" />
