...
=======
  ...
  useEffect(() => {
    fetch(
      `https://twokw-backend.onrender.com/api/v1/football/fixtures?date=${date}`
>>>>>>> 704a815d35995692c77010a6834bc19498ee6d38
    )
      .then((res) => res.json())
      .then((data) => {
        setPrediction(data.data.response || []);
        ...
        <tbody className="text-right">
          {all_predictions.map((item, index) => (
            ...
            >
              <td
                colSpan={100}
                className="w-full flex flex-row lg:gap-2 lg:grid lg:grid-cols-14 lg:justify-between lg:border-none border p-3 lg:p-0 rounded-xl my-4 lg:my-0 lg:active:none active:border-[#1A365D] active:scale-105 active:shadow-xl border-[#1A365D99] lg:active:shadow-none lg:active:scale-none"
              >
                <section className="flex flex-col lg:col-span-10 lg:grid lg:grid-cols-9 justify-between  items-start gap-6 lg:flex-row w-full lg:gap-1 ">
                  <div className="lg:py-5 hidden lg:col-span-1 lg:block lg:mr-12">
                    {index + 1}
                  </div>
                ...
                <section className="flex gap-8 font-light lg:col-span-4 font-sans lg:text-lg lg:font-normal text-xs text-[#737373] items-end lg:flex-row flex-col lg:w-auto lg:justify-center lg:gap-18">
                  ...
                  <div className="lg:py-5 pr-1 w-20 lg:pr-0 ">
                  ...
                  <div
                    ...
                    className="cursor-pointer lg:py-5 lg:ml-4 lg:pr-0 pr-9"
                  >
