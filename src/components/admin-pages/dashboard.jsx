...
export default function DashBoard() {
   ...
   useEffect(() => {
       animate(count1, numbers[0], {duration: 3, ease: "easeOut"});
       animate(count2, numbers[1], {duration: 3, ease: "easeOut"});
       animate(count3, numbers[2], {duration: 3, ease: "easeOut"});
    }, []);
            ...
            <div className="flex">
               ...
               <Sidebar />
                ...
                <div className="flex justify-between gap-6 w-full sm:h-28 sm:m-10">
                    <div className="p-4 bg-[#F3F8FF] text-[#1A365D] rounded-[0.4rem] w-60 shadow-sm">
                        ...
                        <div className="text-4xl font-bold">
                            ...
                            <motion.span className="text-shadow-sm">{statistics1}</motion.span>
                        </div>
                    </div>
                    <div className="p-4 bg-[#F3F8FF] text-[#1A365D] rounded-[0.4rem] w-60 shadow-sm">
                        ...
                        <div className="text-4xl font-bold">
                            ...
                            <motion.span className="text-shadow-sm">{statistics2}</motion.span>
                        </div>
                    </div>
                    <div className="p-4 bg-[#F3F8FF] text-[#1A365D] rounded-[0.4rem] w-60 shadow-sm">
                        ...
                        <div className="text-4xl font-bold">
                            ...
                            <motion.span className="text-shadow-sm">{statistics3}</motion.span>
                        </div>
                    </div>
                </div>
            </div>
