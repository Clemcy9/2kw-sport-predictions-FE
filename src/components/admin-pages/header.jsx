                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="flex justify-center items-center">
                        ...
                        <div className="md:hidden relative ">
                            ...
                            {/* Sidebar */}
                            <aside
                                className={` mt-15.5 bg-[#1A365D] text-[#fff] md:hidden w-full min-h-screen p-4 flex flex-col shadow-lg py-10 fixed top-0 left-0 z-40 transition-transform duration-300
