...
export default function FreeOdds() {
  ...
  return (
    <>
      ...
      <link rel="canonical" href="https://2kwpredicts.com/freeOdds" />
      ...
      <meta property="og:url" content="https://2kwpredicts.com/freeOdds" />
      <meta property="og:type" content="website" />

      <main className="w-full border m-2 bg-white shadow-xl border-[#1A365D] p-4">
