...
const market_type = "double chance";
export default function DoubleChance() {
  ...
  return (
    <>
      ...
      <link rel="canonical" href="https://2kwpredicts.com/double chance" />
      ...
      <meta property="og:url" content="https://2kwpredicts.com/double chance" />
