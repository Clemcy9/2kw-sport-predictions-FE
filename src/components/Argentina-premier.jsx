...
export default function ArgentainaCard () {
    ...
    return (
        <div className="border-none min-w-full md:p-4 my-2 w-full flex justify-center items-center flex-col space-y-4 md:space-y-2">
                <div className="bg-[#1A365D] w-full hover:shadow-lg transition-all flex justify-between items-center p-2 rounded-[0.6rem] text-white">
               ...
               {open && (
                ...
                >
                    <div className="hover:shadow-lg transition-all mt-1 border border-[#D6AE3E] flex justify-between px-4 items-center w-ful flex-col md:flex-row md:p-0 rounded-[0.6rem] max-w-full md:max-w-fit">
                    ...
                    {/* second row */}
                    <div className="hover:shadow-lg transition-all border border-[#D6AE3E] flex justify-between px-4 items-center w-ful flex-col md:flex-row md:p-0 rounded-[0.6rem]">
