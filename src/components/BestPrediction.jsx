...
export default function BestPredictionCard () {
    ...
    return (
        <div className="relative  border-none mt-40 min-[440px]:mt-25 min-[450px]:mt-27 max-[332px]:mt-53 max-[300px]:mt-55 max-[241px]:mt-75 md:mt-5 md:h-[350px] h-[260px] min-h-[180px] rounded-[0.6rem] md:mb-0 p-4 bg-[#1a365d] md:max-w-[400px] w-full flex items-center flex-col md:space-y-2 shadow-lg transition-all">
            <h2 className="text-center text-lg sm:text-xl font-semibold text-white md:py-2 py-0">
                Best Prediction of the Day
            </h2>
            <motion.div
                className="max-w-md w-full bg-[#1A365D] text-white flex items-center justify-between"
                transition={{ duration: 0.7, ease: "easeOut" }}
            >
               

                <div className="flex justify-between items-center flex-col font-sans md:space-y-3 space-y-1 text-white/80">
                   ...
                   <span className="text-white">vs</span>
                    ...
                    <div className="flex flex-col items-center space-y-1">
                        ...
                        />
                        <span className="text-sm font-medium ">{predictions.awayTeam}</span>
                    </div>
                </div>

                <div className="text-center flex justify-between items-start flex-col md:space-y-9 space-y-5">
                    ...
                    <p className="md:text-[1.1rem] text-[1rem] max-[267]:flex  text-white"><span>🗓️</span>wen-{predictions.date}</p>
                </div>
                ...
                <div className="border-1 border-b-0 border-x-0 border-t-white/20 w-full flex items-center justify-center flex-col">
                    ...
                    <div className="flex justify-center items-center text-sm space-y-2 text-white/80 w-full gap-2 sm:gap-3">
